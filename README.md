...
| Потенциал развития и оригинальность | 10 | Разбор намерения из свободного текста (`service_intent`, `interpreted_intent`) как расширяемый, но безопасный (валидируемый) AI-слой поверх детерминированного ядра |
